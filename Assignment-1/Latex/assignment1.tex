...
&=\myvec{\dfrac{3\text{-}4k}{4} \\ \dfrac{6+2k}{4}}\label{eq:eq2}
\end{align}
Taking the $y$-coordinates from \eqref{eq:eq1} and \eqref{eq:eq2} get,
\begin{align}
...
&=\text{-}2.25
\end{align}
$\therefore$ the point $\vec{P}$= \myvec{\text{-}2.25\\3}
\item The length of the line $\overrightarrow{\vec{AP}}$ can be measured by \bigskip the distance formula.\\ 
\begin{align}
\text{Length of $\overrightarrow{\vec{AP}}$} &= \sqrt[2]{(\text{-}4-(\text{-}2.25))^2+(2-3)^2}\\
&= 2.015
\end{align} 
