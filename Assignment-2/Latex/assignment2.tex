...
\implies sin^{\text{-}1}(1-x) &= \frac{\pi}{2} - 2sin^{\text{-}1}x\\
\implies sin\left(\frac{\pi}{2}-2sin^{\text{-}1}x\right)&= (1-x)\\
\implies cos(2sin^{\text{-}1}x)&=(1-x)\label{eq:3}
\end{align}
We know that,
\begin{align}
cos(2y)=1-2sin^{2}y\label{eq:4}
\end{align}
From equation \eqref{eq:3} and \eqref{eq:4} we get,
\begin{align}
\implies 1-2sin^{2}(sin^{\text{-}1}x)&= (1-x)\label{eq:5}
\end{align}
Also,
\begin{align}
